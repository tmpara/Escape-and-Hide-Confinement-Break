...
export class RoomsData {
  ...
  mainRooms: string[] = ['startingRoom', 'endingRoom'];

  constructor() {
    this.labComplex1 = new Room(15, 15, ['up', 'left', 'right', 'down'], []);
    this.labComplex1.layout = Array.from(
      { length: this.labComplex1.width },
      () => Array.from({ length: this.labComplex1.height })
    );
    ...
    this.startingRoom.layout = Array.from(
      { length: this.startingRoom.width },
      () => Array.from({ length: this.startingRoom.height })
    );
    new RoomTransition('left');
    ...
    this.crossHall1.layout = Array.from({ length: this.crossHall1.width }, () =>
      Array.from({ length: this.crossHall1.height })
    );
    ...
    this.verticalHall.layout = Array.from(
      { length: this.verticalHall.width },
      () => Array.from({ length: this.verticalHall.height })
    );
    ...
    this.horizontalHall.layout = Array.from(
      { length: this.horizontalHall.width },
      () => Array.from({ length: this.horizontalHall.height })
    );
    ...
    this.cornerRoom.layout = Array.from({ length: this.cornerRoom.width }, () =>
      Array.from({ length: this.cornerRoom.height })
    );
    ...
    this.cornerRoomInverted.layout = Array.from(
      { length: this.cornerRoomInverted.width },
      () => Array.from({ length: this.cornerRoomInverted.height })
    );
    ...
    this.cornerRoomMirrored.layout = Array.from(
      { length: this.cornerRoomMirrored.width },
      () => Array.from({ length: this.cornerRoomMirrored.height })
    );
    ...
    this.cornerRoomInvertedMirrored.layout = Array.from(
      { length: this.cornerRoomInvertedMirrored.width },
      () => Array.from({ length: this.cornerRoomInvertedMirrored.height })
    );
    ...
    this.TRoom.layout = Array.from({ length: this.TRoom.width }, () =>
      Array.from({ length: this.TRoom.height })
    );
    ...
    this.TRoomInverted.layout = Array.from(
      { length: this.TRoomInverted.width },
      () => Array.from({ length: this.TRoomInverted.height })
    );
    ...
    this.TRoomMirrored.layout = Array.from(
      { length: this.TRoomMirrored.width },
      () => Array.from({ length: this.TRoomMirrored.height })
    );
    ...
    this.TRoomInvertedMirrored.layout = Array.from(
      { length: this.TRoomInvertedMirrored.width },
      () => Array.from({ length: this.TRoomInvertedMirrored.height })
    );
    ...
    this.DeadEndRoomUp.layout = Array.from(
      { length: this.DeadEndRoomUp.width },
      () => Array.from({ length: this.DeadEndRoomUp.height })
    );
    this.DeadEndRoomUp.layout[2][0] = new RoomTransition('up');

    this.DeadEndRoomDown = new Room(5, 5, ['down'], []);
    this.DeadEndRoomDown.layout = Array.from(
      { length: this.DeadEndRoomDown.width },
      () => Array.from({ length: this.DeadEndRoomDown.height })
    );
    this.DeadEndRoomDown.layout[2][4] = new RoomTransition('down');

    this.DeadEndRoomLeft = new Room(5, 5, ['left'], []);
    this.DeadEndRoomLeft.layout = Array.from(
      { length: this.DeadEndRoomLeft.width },
      () => Array.from({ length: this.DeadEndRoomLeft.height })
    );
    this.DeadEndRoomLeft.layout[0][2] = new RoomTransition('left');

    this.DeadEndRoomRight = new Room(5, 5, ['right'], []);
    this.DeadEndRoomRight.layout = Array.from(
      { length: this.DeadEndRoomRight.width },
      () => Array.from({ length: this.DeadEndRoomRight.height })
    );
    this.DeadEndRoomRight.layout[4][2] = new RoomTransition('right');

    this.endingRoom = new Room(13, 13, ['up', 'left', 'right', 'down'], []);
    this.endingRoom.layout = Array.from({ length: this.endingRoom.width }, () =>
      Array.from({ length: this.endingRoom.height })
    );
