...
import { Wall1,WallCorner1,ExplosiveBarrel,DoorHorizontal,DoorVertical,RoomTransition,Crate,WeaponCrate,MedicalCrate,Mine,CryoChamber,GlassShards,WallSign1,Spawnpoint} from './entities'
...
export class RoomsData {
    ...
    constructor() {
        ...
        this.storageComplex1.layout[7][7] = new Spawnpoint("enemy");
        ...
        this.endingRoom.layout[5][8] = new WallCorner1();
