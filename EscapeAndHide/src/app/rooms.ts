...
export class RoomsData {
    ...
    constructor() {
        ...
        this.startingRoom.layout = Array.from({ length: this.startingRoom.height }, () => Array.from({ length: this.startingRoom.width }, () => ""));
        ...
        this.labComplex1.layout = Array.from({ length: this.labComplex1.height }, () => Array.from({ length: this.labComplex1.width }, () => ""));
        ...
        this.labComplex1.layout[14][5] = "wall_basic";
        ...
        this.labComplex1.layout[5][14] = "wall_basic";
        ...
        this.labComplex1.layout[9][14] = "wall_basic";

        this.crossHall1 = new Room(15, 15, ["up", "left", "right", "down"], []);
        this.crossHall1.layout = Array.from({ length: this.labComplex1.height }, () => Array.from({ length: this.labComplex1.width }, () => ""));
